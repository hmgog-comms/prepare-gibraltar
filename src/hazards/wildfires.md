...
title: "Wildfires (Nature Reserve)"
summary: Gibraltar's Upper Rock Nature Reserve (URNR) is vulnerable to wildfire, particularly during the high-risk season, when vegetation is extremely dry. Fires can spread rapidly, threatening human life, wildlife, property, and air quality across the territory.
thumbnail: /assets/images/hazards/wildfires.webp
at_risk: The lives of people residing, walking, or visiting the Upper Rock Nature Reserve are at direct risk during a wildfire. Residents in areas bordering the Nature Reserve may also be affected by smoke and/or falling embers, or be required to evacuate. Those with respiratory conditions are at increased risk from smoke inhalation across the wider territory.
tags: hazards
before: |

  - Do not light fires, use barbecues or smoke in public areas, within or near the Nature Reserve. This is prohibited and a leading cause of wildfires.
  - Report any unattended fire or smoke in the Nature Reserve immediately to the Gibraltar Fire and Rescue Service.
  - If you live in or near the Nature Reserve, clear dry vegetation, leaves and debris from around your property.
